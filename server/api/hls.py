...
async def get_master_playlist(
    ...
    # Build audio_tracks list from indices — caller must provide matching labels via status
    # We reconstruct minimal dicts from the indices; full labels come from the tracks endpoint
